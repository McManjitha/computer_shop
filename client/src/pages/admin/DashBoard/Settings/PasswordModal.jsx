...
const PasswordModal = ({ handleClose, selectedUser }) => {
    ...
    const handleSubmit = async () => {
        ...
        formData.append("oldPassword", inputs.oldPassword.data);
        formData.append("newPassword", inputs.newPassword.data);
        formData.append("newPasswordConf", inputs.newPasswordConf.data);
