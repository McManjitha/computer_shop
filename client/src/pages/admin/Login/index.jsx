...
const Loginform = () => {
    ...
    return (
        <div className="bg-img h-screen w-full flex justify-center items-center">
            <NavBar />
            <ToastContainer />
            <form className="drop-blur-lg bg-white dark:bg-black dark:bg-opacity-30 bg-opacity-80  w-[80vw] lg:w-[40vw] pb-20 mx-auto  shadow-lg rounded-xl  bg-clip-padding  flex flex-col items-center">
                <h2 className="w-full  text-center bg-[#483D8B] text-white font-bold text-2xl md:text-2xl  mb-2 rounded-t-lg py-1">
                    Admin login
                </h2>
                <img
